...
**Impact:** CRITICAL
**Description:** Core performance optimizations for Vite dev server and build process. Covers barrel file elimination, plugin auditing, import resolution, file warmup, and native tooling. These rules can reduce dev server startup by 50-80% and initial page load by 40-70%.

## 8. Bundle Analysis (bundle)
